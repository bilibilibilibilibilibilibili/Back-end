...
@MappedTypes(value = {MediaResource.class})
@MappedJdbcTypes(JdbcType.LONGVARCHAR)
public class ListObjectTypeHandler<T> implements TypeHandler<List<T>> {

    private Class<T> targetClass;
    private static final ObjectMapper OBJECT_MAPPER = new ObjectMapper();

    public ListObjectTypeHandler(Class<T> targetClass) {
        if (targetClass == null){
