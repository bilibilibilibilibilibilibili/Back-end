...
//    int addPost(Post post);
    ...
    @Results(id="PostMap", value={
            ...
            @Result(property = "mediaResources", column = "resources", jdbcType = JdbcType.LONGVARCHAR, typeHandler = ListTypeHandler.class),
    ...
    List<PostTest> selectPostByLastComment(@Param("offset") int offset);
